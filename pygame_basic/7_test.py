...
# 적 enemy 캐릭터
enemy = pygame.image.load("/Users/hongsungpyo/Desktop/Code/Python/pygame_1.py/enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해온다
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width - enemy_width) / 2 # 화면 가로의 절반에 위치
enemy_y_pos = (screen_height - enemy_height) / 2 # 화면 세로 크기 가장 아래 위치
